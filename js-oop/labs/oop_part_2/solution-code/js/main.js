...
function displayPanelContent (contentType) {
  ...
  switch(contentType) {
    case 'vehicle':
      displayVehicles(options, contentType);
      break;
    case 'color':
...
function displayVehicles (options, contentType) {
  for (var i = 0; i < options.length; i++) {
    var html = '';
    html += '<div class="col-md-6 vehicle-option ' + this[options][i].choice + '" data-panel="vehicle" data-price="' + this[options][i].choice + '" data-option="' + this[options][i].choice + '"></div>'
